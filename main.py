...
import time
# Load the image
PATH_IMAGE = './examples/0.png'
PATH_MODEL = './model/model.pt'
PATH_FONT = './ariali.ttf'
...
mocr = MangaOcr()
results = detect_bubbles(PATH_MODEL, PATH_IMAGE)
for result in results:
        ...
        text_translated = manga_translator.translate(text, method="bing")
        time.sleep(1)
        add_text(detected_image, text_translated, PATH_FONT, cont)
